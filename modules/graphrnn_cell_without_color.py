...
class GraphRNNCell_2N_1MAX(object):
    ...
    def __call__(self, inputs, states):
        ...
        print("[1] correlation_1 = [S_point | S_neighborhodd | displacement | displacement_feat| displacement_time] " )
...
def point_feat(P1,
    ...
    if F1 is not None:
    	...
    	correlation = tf.concat([correlation,displacement], axis=3)
    else:
    	correlation = tf.concat([P1_grouped, displacement], axis=3)                     # batch_size, npoint, nsample, out_channels+3
