"""
Script to Train a Graph-RNN model with COLOR 
...
from datasets.Bodies_Random import Bodys as Bodies_Random_color
# Load Short-Term Model with Color
...
parser.add_argument('--max-gradient-norm', type=float, default=1.0e10, help='Clip gradients[default: 5.0 or 1e10 no clip].')
# data paramenters
...
print("\n ==== GRAPH-RNN for BODIES with COLOR DATASET  ====== \n")

#Define training dataset
train_dataset = Bodies_Random_color(root=args.data_dir,
...
#with tf.Session( ) as sess:
	...
	# WRITE LOG
        ...
        if(  ((i+1) % 1000 == 0) ):
        	print("[Dataset Loaded] ",train_dataset )         
        	train_dataset = Bodies_Random_color(root=args.data_dir,seq_length=args.seq_length,
                        num_points=args.num_points,
                        train=True)
	...
	# SAVE CHECKPOINT
        ...
        # Save Example
        if ( (i+1) % args.save_iters == 0 or i==0 or i==20):
        	...
        	#print("downsample_frames[frame=1][point=2]",downsample_frames[1][2])
