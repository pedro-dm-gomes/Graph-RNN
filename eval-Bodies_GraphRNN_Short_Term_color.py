...
from models.GraphRNN_color_ShortTerm import AdvancedGraphRNN as Model
...
parser.add_argument('--ckpt-step', type=int, default=150000, help='Checkpoint step [default: 200000]')
...
parser.add_argument('--log-dir', default='outputs/GraphRNN_ShortTerm_Color', help='Log dir [outputs/bodys-pointrnn]')
