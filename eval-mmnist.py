...
from models.mmnist_GraphRNN import BasicGraphRNN as Model
...
parser.add_argument('--ckpt-step', type=int, default=127560, help='Checkpoint step [default: 200000]')
...
parser.add_argument('--log-dir', default='outputs/mmnist-2digit-basic-graphrnn', help='Log dir [default: outputs/mmnist-2digit-advanced-pointlstm]')
