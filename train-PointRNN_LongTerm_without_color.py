...
from PIL import Image
import models.PointRNN_without_color_LongTerm as models
...
parser.add_argument('--save-examples', type=int, default= 10000, help='Iterations to save examples [default: 1000]')
...
parser.add_argument('--unit', type=str, default='pointrnn', help='Unit. graphrnn, pointgru or pointlstm [default: pointrnn]')
...
parser.add_argument('--log-dir', default='outputs/PointRNN_LongTerm_Without_Color', help='Log dir [default: outputs]')
...
"""  # =====    LOAD MODEL   ==========  """
model_name = args.mode.capitalize() + 'Point' + args.unit[5:].upper() #Returns PointRNN/LSTM
...
checkpoint_path_restore = os.path.join(checkpoint_dir, 'ckpt-3')
