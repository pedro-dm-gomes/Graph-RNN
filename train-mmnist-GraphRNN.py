...
parser.add_argument('--num-points', type=int, default=256, help='Number of points [default: 128]')
...
checkpoint_path_restore = os.path.join(checkpoint_dir, 'ckpt-3600')
...
log = open(os.path.join(args.log_dir, 'train_pt.log'), 'w')
...
with tf.Session(  config = config) as sess:
    ...
    for i in range(0, args.num_iters):
        ...
        print('[GEO] [%10d:]\t%.12f\t%.12f'%(i+1, cd, emd))
