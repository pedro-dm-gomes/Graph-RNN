"""
PointRNN++ cal-cd-emd for mnist data
Original Author: Hehe Fan
"""
...
parser.add_argument('--gt', type=str, default='/home/uceepdg/profile.V6/Desktop/MNIST/test-2mnist-64-256point-20step.npy', help='Ground truth npy file.')
parser.add_argument('--pd', type=str, default='outputs/mmnist-2digit-basic-graphrnn/test-predictions.npy', help='Prediction npy file.')
