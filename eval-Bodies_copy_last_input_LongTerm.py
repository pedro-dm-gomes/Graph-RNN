...
from models.CopyLastInput_without_color_LongTerm import Copy_Last_Input as Model
...
parser.add_argument('--log-dir', default='outputs/Bodys_Long_Term_copy_last_input', help='Log dir [outputs/bodys-pointrnn]')
...
log = open(os.path.join(args.log_dir, 'test_Bodies_copy_last_input.log'), 'w')
log_frame = open(os.path.join(args.log_dir, 'test_Bodies_frames_copy_last_input.log'), 'w')
