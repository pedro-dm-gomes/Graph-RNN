...
from PIL import Image
import models.mmnist_GraphRNN as models
...
input_points_dir = '/home/uceepdg/profile.V6/Desktop/Datasets/NPYs_Bodys/800000'
input_color_dir = '/home/uceepdg/profile.V6/Desktop/Datasets/NPYs_Bodys_Color/800000'
...
with tf.Session(config = config) as sess:
	...
	for character in sorted (os.listdir(input_points_dir)):
		...
		if(character =='JPEG' or character =='Sghae'):
			for sequence in sorted(os.listdir(character_path), reverse =True):
				if(sequence == 'redandblack'):
					...
					for frame in range(0,length):
						...
						xyz, feat, color, _, _ = sample_and_group(int(nr_points), radius=0.1+1e-20, nsample=1, xyz=xyz, features=None, color=color, knn=False, use_xyz=False) #params dont matter
