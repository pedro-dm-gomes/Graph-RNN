...
from models.GraphRNN_without_color_ShortTerm import AdvancedGraphRNN as Model
...
parser.add_argument('--log-dir', default='outputs/GraphRNN_ShortTerm_Without_Color', help='Log dir [outputs/bodys-pointrnn]')
