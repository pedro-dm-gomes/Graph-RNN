...
base_ply ='/media/pedro/HardDrive/JPEG/soldier/soldier/Scaled_Ply/'
ply_input = base_ply
...
cmd =' python /home/pedro/Desktop/convert_ply_npy_points.py  ' + ply_input + ' --output_dir ' + npy_output
#print("cmd :",cmd)
...
npy_output =os.path.splitext(npy_output)[0]
print("npy_output: ",npy_output)
cmd =' python /home/pedro/Desktop/convert_ply_npy_color.py  ' + ply_input + ' --output_dir ' + npy_output
#print("cmd :",cmd)
subprocess.call([ cmd], shell=True)
...
for character in os.listdir(root):
	...
	if (character == 'Soldier_Steve' ):
		for sequence in os.listdir(character_path):
			if(sequence == 'Can_Can.fbx'  ):
				...
				npy_output =os.path.splitext(npy_output)[0]
				print("npy_output: ",npy_output)
				cmd =' python /home/pedro/Desktop/convert_ply_npy_points.py  ' + ply_output + ' --output_dir ' + npy_output
				#print("cmd :",cmd)
				#subprocess.call([ cmd], shell=True)
				...
				npy_output =os.path.splitext(npy_output)[0]
				print("npy_output: ",npy_output)
				cmd =' python /home/pedro/Desktop/convert_ply_npy_color.py  ' + ply_output + ' --output_dir ' + npy_output
				#print("cmd :",cmd)
				#subprocess.call([ cmd], shell=True)
