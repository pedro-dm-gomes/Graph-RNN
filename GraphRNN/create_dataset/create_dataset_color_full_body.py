...
root= '/media/pedro/HardDrive/Dataset/FBX_Test'
...
for character in os.listdir(root):
	...
	if (character == 'James'):
		for sequence in os.listdir(character_path):
			if(sequence == 'Running.fbx' or sequence == 'Stabbing.fbx' or sequence == 'Walking_Backwards.fbx' or sequence == 'Walk_With_Rifle.fbx'  ):
