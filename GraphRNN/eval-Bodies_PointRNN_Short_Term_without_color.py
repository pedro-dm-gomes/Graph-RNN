...
from models.PointRNN_without_color_ShortTerm import AdvancedPointRNN as Model
...
parser.add_argument('--log-dir', default='outputs/PointRNN_ShortTerm_Without_Color', help='Log dir [outputs/bodys-pointrnn]')
