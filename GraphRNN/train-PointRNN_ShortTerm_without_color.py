...
from PIL import Image
import models.PointRNN_without_color_ShortTerm as models
...
parser.add_argument('--save-examples', type=int, default= 10, help='Iterations to save examples [default: 1000]')
...
parser.add_argument('--log-dir', default='outputs/PointRNN_ShortTerm_Without_Color', help='Log dir [default: outputs]')
