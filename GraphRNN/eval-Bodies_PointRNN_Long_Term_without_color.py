...
from models.PointRNN_without_color_LongTerm import AdvancedPointRNN as Model
...
parser.add_argument('--log-dir', default='outputs/PointRNN_LongTerm_Without_Color', help='Log dir [outputs/bodys-pointrnn]')
