...
from PIL import Image
import models.GraphRNN_without_color_ShortTerm as models
...
parser.add_argument('--log-dir', default='outputs/GraphRNN_ShortTerm_Without_Color', help='Log dir [default: outputs]')
...
checkpoint_path_restore = os.path.join(checkpoint_dir, 'ckpt-31900')
